...
The full experimental pipeline used in this project is summarized in \autoref{fig:experimental_pipeline}. A structured PDE description is first embedded with a frozen text encoder, while the numerical branch receives four input timesteps of multi-channel PDE fields. The conditioned UNet concatenates both sources of information to predict the next state, and performance is then evaluated through autoregressive rollout on an OOD benchmark.
